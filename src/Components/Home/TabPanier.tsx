...
const Tabproduct: React.FC<TabproductProps> = ({ product }) => {
  ...
  return (
    <Link href={`/Home/${product.id}`}>
      <div className="relative flex flex-col max-w-sm w-full bg-gray-200 border border-black rounded-lg shadow-md overflow-hidden m-4">
        ...
        <div className="flex flex-col justify-between p-4 h-48">
          ...
          <div className="flex items-center justify-between mt-auto">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xs font-semibold text-yellow-700 bg-yellow-200 px-2 py-0.5 rounded">
                5.0
              </span>
            </div>
          </div>
